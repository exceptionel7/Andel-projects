  ...
  const html = `
    ...
    <body style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;color:#333">
      ...
      <div style="text-align:center;padding:20px 0;border-bottom:3px solid #FF9900">
        <h1 style="color:#131921;margin:0">Exceptionel</h1>
      ...
      <div style="padding:24px 0">
        ...
        <h3 style="color:#131921;border-bottom:1px solid #eee;padding-bottom:8px">Your Items</h3>
        ...
        <h3 style="color:#131921;border-bottom:1px solid #eee;padding-bottom:8px;margin-top:24px">Shipping To</h3>
